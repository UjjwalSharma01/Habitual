    ...
    <div className="px-6 py-10 sm:px-12">
      ...
      >
        <motion.div 
          ...
          className="mx-auto w-24 h-24 rounded-full bg-blue-100 flex items-center justify-center"
        >
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-100 max-w-lg mx-auto"
        >
          <h3 className="font-medium text-lg text-blue-800 mb-3">What makes a successful habit?</h3>
